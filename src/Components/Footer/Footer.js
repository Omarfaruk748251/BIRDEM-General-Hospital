    ...
    return (
        <div className='footer-container py-5'>
                ...
                <div className="col-lg-3 ">
                    ...
                    <nav>
                        <ul className='list-unstyled text-white '>
                            <li className='py-2 footer-item'>Phone :- <br /> +880 1863700417</li>
                            <li className='py-2 footer-item'>Email :- <br /> foysal748251@gmail.com</li>
                            <li className='py-2 footer-item'>Address :- <br /> Rampura, Dhaka, Bangladesh</li>
                        </ul>
                    </nav>
                </div>
                <div className="col-lg-3">
            ...
            <div className='text-center text-white border-top pt-4 copyright-text'>
                <p>Copyright @2021 BIRDEM General Hospital</p>
            </div>
        </div>
    );
};
